...
export default function StatsCard({ tasks, language = 'ar' }: StatsCardProps) {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-5 shadow-sm space-y-5 transition-all">
      ...
      <div className="flex items-center justify-between bg-slate-50/50 dark:bg-slate-800/30 p-4 rounded-xl border border-slate-100 dark:border-slate-800/80">
        ...
        <div className="relative flex items-center justify-center w-24 h-24">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center font-sans">
            ...
            <span className="text-[14px] font-extrabold text-slate-700 dark:text-slate-300 leading-none">{percentage}%</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        {/* Completed */}
        <div className="bg-emerald-50/20 dark:bg-emerald-950/20 border border-emerald-100/50 dark:border-emerald-900/30 p-2.5 rounded-xl text-center">
        ...
        {/* Pending */}
        <div className="bg-slate-50/80 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800/80 p-2.5 rounded-xl text-center">
          <div className="w-6 h-6 rounded-lg bg-slate-500/10 flex items-center justify-center mx-auto mb-1 text-slate-600 dark:text-slate-400">
            <ListTodo size={14} />
          </div>
        ...
        <div className="bg-rose-50/20 dark:bg-rose-950/20 border border-rose-100/50 dark:border-rose-900/30 p-2.5 rounded-xl text-center">
