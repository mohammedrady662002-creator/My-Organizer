    ...
    <div className={`h-full flex flex-col bg-slate-50 dark:bg-[#0F172A] text-slate-600 dark:text-[#94A3B8] relative border-slate-200 dark:border-white/5 transition-all duration-300 ${
      ...
      <div className={`p-6 flex items-center justify-between border-b border-slate-200 dark:border-white/5 ${isCollapsed ? 'justify-center p-4' : ''}`}>
        ...
        {!isCollapsed && (
          <button 
            ...
            className="hidden md:flex p-1.5 rounded-lg border border-slate-200 dark:border-white/5 bg-[#F5F5F4] dark:bg-[#1E293B] text-slate-600 dark:text-white hover:bg-slate-100 dark:hover:bg-[#334155] cursor-pointer transition-colors"
          >
        ...
        {isOpenMobile && (
          <button 
            ...
            className="md:hidden p-1.5 rounded-lg bg-[#F5F5F4] dark:bg-[#1E293B] border border-slate-200 dark:border-white/5 text-slate-600 dark:text-white cursor-pointer hover:bg-slate-100 dark:hover:bg-[#334155]"
          >
            <X size={14} />
          </button>
        )}
      ...
      {!isCollapsed && user && (
        <motion.div 
          ...
          className="p-4 mx-4 mt-6 rounded-2xl bg-[#F5F5F4] dark:bg-gradient-to-br dark:from-[#1E293B] dark:to-[#111827] border border-slate-200 dark:border-white/5 shadow-sm dark:shadow-none relative overflow-hidden group shrink-0"
        >
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl font-medium text-sm transition-all relative cursor-pointer group ${
                isActive 
                  ...
                  : 'text-slate-600 dark:text-[#94A3B8] hover:text-indigo-600 dark:hover:text-white hover:bg-slate-200/50 dark:hover:bg-[#F5F5F4]/5'
              }`}
      ...
      <div className="p-4 border-t border-slate-200 dark:border-white/5 space-y-2 shrink-0">
        {isCollapsed ? (
          <button 
            ...
            className="w-full h-10 rounded-xl flex items-center justify-center hover:bg-slate-200 dark:hover:bg-[#F5F5F4]/5 cursor-pointer text-slate-500 dark:text-white"
